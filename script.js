...
// Passing direct Firestore ID to completely eliminate index misalignment
...
async function fetchUpdates() {
  ...
  try {
    ...
    actualIssues.forEach((issue, index) => {
      ...
      // Robust Regex matching to safely extract markdown and HTML images uploaded via GitHub
      ...
      // Strip image syntaxes out of description for clean text excerpt
