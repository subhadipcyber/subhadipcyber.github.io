...
function revealOnScroll() {
  ...
  const elementVisible = 50; // Triggers 50px before element enters view
...
function switchPage(pageId) {
  ...
  // Re-trigger scroll reveal logic on new page load
...
async function fetchUpdates() {
  ...
  try {
    ...
    actualIssues.forEach((issue, index) => {
      ...
      // Added reveal-up class and dynamic delay for staggered entry animation
    ...
    // Trigger animations for the newly created elements
...
let chatHistory = [
  {
    ...
    You represent SCT Creative Studio.
